...
import { News1, News2, News3, News4 } from "../../constants";
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-7 col-12">
            <div className="news-block mb-4">
              <div className="news-block-top">
                <a href="news-detail.html">
                  <img src={News1} className="news-image img-fluid" alt="" />
                </a>
            ...
            <div className="news-block mt-3">
              <div className="news-block-top">
                <a href="news-detail.html">
                  <img src={News2} className="news-image img-fluid" alt="" />
                </a>
          ...
          <div className="col-lg-4 col-12 mx-auto">
            ...
            <div className="news-block news-block-two-col d-flex mt-4">
              <div className="news-block-two-col-image-wrap">
                <a href="news-detail.html">
                  <img src={News3} className="news-image img-fluid" alt="" />
                </a>
              </div>
            ...
            <div className="news-block news-block-two-col d-flex mt-4">
              <div className="news-block-two-col-image-wrap">
                <a href="news-detail.html">
                  <img src={News4} className="news-image img-fluid" alt="" />
                </a>
              </div>
